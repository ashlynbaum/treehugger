class TreeBadgesController < ApplicationController
  ...
  def index
    ...
    # variable names:
    @badge_names =  ["@fernland_badges", "@manuka_and_kanaka_badges", "@podocarp_giants_badges", "@mangrove_badges", "@deciduous_hardwood_badges", "@nothofagus_beech_badges", "@exotic_badges"]
    @forest_names =  ["@fernland_badges", "@manuka_and_kanaka_badges", "@podocarp_giants_badges", "@mangrove_badges", "@deciduous_hardwood_badges", "@nothofagus_beech_badges", "@exotic_badges"]
