...
Tree.create do |s|
	s.id = 3
	s.name = "Kahikatea"
	s.description = "Kahikatea is the largest tree native to Aotearoa with records from early settlers showing specimen of over 80m. Soot obtained from burning the heartwood supplied a pigment for tā moko. Since the wood does not impart an odour, and is clean and lightweight, Kahikatea was used to make boxes for the exporting of butter from the 1880s on. On young plants the leaves are 3-8mm long and twisted at the base to lie spread to the sides of the shoot in a flat plane; on mature trees, they are scale-like, 1-3 mm long, and placed all round the shoot."
	s.forest_id = 3
...
Tree.create do |s|
	s.id = 6
	s.name = "Tawhai Raunui (Red Beech)"
	s.description = "The Red Beech is a medium-sized evergreen tree growing to 35 m tall. The leaves are alternately arranged, broad ovoid, 2 to 4 cm long and 1.5 to 3 cm broad, the margin distinctively double-toothed with each lobe bearing two teeth. The fruit is a small cupule containing three seeds. Pollen from the tree was found near the Antarctic Peninsula showing that it formerly grew i Antarctica since the Eocene period."
	s.forest_id = 6
end

Tree.create do |s|
	s.id = 8
	s.name = "Tawhai Rauriki (Mountain Beech)"
	s.description = "The Mountain Beech, found in alpine regions, grows to around 20 metres but near the treeline forms a 'goblin forest' where the trees are no more than 2m tall. It also has leaves that are elongated and have a pointed end."
	s.forest_id = 6
end

Tree.create do |s|
	s.id = 9
	s.name = "Tawhai Rauriki (Black Beech)"
	s.description = "Black Beech is known as black beech because it is prone to a sooty mold which covers the trunk and branches. This, in turn, is the result of a scale insect which sucks sap from the tree, and excretes honeydew, a sweet liquid, in small droplets (less than 1 mm diameter) on the end of stalks. This feeds the sooty mold, and also forms a valuable high-energy food source for various birds and insects including the kākā. The infestation is common and does not appear to harm the tree."
	s.forest_id = 6
end

Tree.create do |s|
	s.id = 7
	s.name = "Tawhai Raunui (Hard Beech)"
	s.description = "Due to the high tannin content, the bark of this Beech has traditionally been used for tanning leather. The coriaceous, hairless broadly ovate leaves range from 2.5-4cm long, and have from eight to twelve pairs of coarse, blunt teeth. The slate to dark grey bark is thick and furrowed. The tiny red male flowers are bell-shaped and produced in large numbers while the female flowers, which are green tipped with brown, are in groups of three on short stalks growing in the axils of the leaves. "
	s.forest_id = 6
end
